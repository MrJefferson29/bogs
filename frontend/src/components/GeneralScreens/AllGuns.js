...
export default function AllGuns() {
  ...
  return (
    <AllGunsStyles>
      ...
      <p style={{fontWeight: 600}}>Browse All guns by category</p>
          ...
          <div className="card-wrapper" key={index} onClick={() => handleCardClick(gun.name)}>
            ...
            <div className='info'>
              <div className='info-left'>
                ...
                <span className='text'>Mechanism</span> {gun.mechanism}<br />
                <span className='text'>Model</span> {gun.model}<br />
              </div>
              <div className='info-right'>
                <span className='text'>Subcategory</span> {gun.subcategory}<br />
                <span className='text'>Make</span> {gun.make}<br />
                <span className='text'>Calibre</span> {gun.calibre}<br />
              </div>
            </div>
